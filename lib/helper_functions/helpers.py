...
def become_member(id):
    print("\nIn order to become a flatstop member you'll need to complete a quick survey: ")
    while True:
        choice = input("Complete survey?[y/N]> ").lower()
        if choice == "y":
            choice1 = input("\nWhat genre of game do you usually play? ")
            choice2 = input("\nWe want to recommend you games that you'll like. What is your preferred game rating? ")
            choice3 = input("\nWhat is your favorite game that you currently own? ")
